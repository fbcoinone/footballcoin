/* src/config/footballcoin-config.h.  Generated from footballcoin-config.h.in by configure.  */
/* src/config/footballcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FOOTBALLCOIN_CONFIG_H

#define FOOTBALLCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The FootBallcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "FootBallcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/footballcoin/footballcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FootBallcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FootBallcoin Core 0.15.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "footballcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://footballcoincore.org/"
