...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. FootBallCoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    //mapArgs["-addnode"]="47.75.69.228";
    //mapArgs["-addnode"]="server-3.fbcoin.one";
    //mapArgs["-addnode"]="server-2.fbcoin.one";
