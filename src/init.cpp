...
{
  //  const std::string URL_SOURCE_CODE = "<https://github.com/footballcoin-project/footballcoin>";
   // const std::string URL_WEBSITE = "<https://footballcoin.org>";

const std::string URL_SOURCE_CODE = "<https://github.com/fbcoinone>";
   const std::string URL_WEBSITE = "<https://fbcoin.one>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("FootBallCoin version %s\n", FormatFullVersion());
}
