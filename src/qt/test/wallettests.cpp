...
#include <test/test_footballcoin.h>
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FootBallcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_footballcoin-qt -platform xcb      # Linux
//     src/qt/test/test_footballcoin-qt -platform windows  # Windows
//     src/qt/test/test_footballcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FootBallcoinUnits::formatWithUnit(unit, balance, false, FootBallcoinUnits::separatorAlways);
    ...
    // Amount input
    FootBallcoinAmountField* amountInput = receiveCoinsDialog.findChild<FootBallcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: footballcoin:")) != -1);
