...
#ifndef FOOTBALLCOIN_QT_FOOTBALLCOINUNITS_H
#define FOOTBALLCOIN_QT_FOOTBALLCOINUNITS_H
...
/** FootBallcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FootBallcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FootBallcoinUnits(QObject *parent);

    /** FootBallcoin units.
      @note Source: https://en.footballcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FBC,
...
typedef FootBallcoinUnits::Unit FootBallcoinUnit;

#endif // FOOTBALLCOIN_QT_FOOTBALLCOINUNITS_H
